...
fs.readFile(caminar, 'utf8', (error, elDatos) => {
  ...
  // console.log("El contenido es: ", datos);
let tt =  destriparDatos(elDatos)
// console.log(tt)
// 
return tt.then(dd=>{
// console.log(dd)
contenido.push(dd)
return myResolve(contenido)
})
...
// fin toodo
  ...
  // recorrer();
  let  xx=  cargarDatos('./todos/megamenu--electrodomesticos/megamenu--electrodomesticos-006.txt')
console.log('salida xx ',await xx)
